...
class CentralityHiding:
    ...
    def hide_target_node_from_community(self, seed) -> Tuple[nx.Graph, List[int], int]:
        ...
        for edge in self.possible_edges:
            ...
            # Compute the eigenvector centrality of the node

            possible_edges.append((edge[0], edge[1], self.centrality[edge[1]]))
...
if __name__ == "__main__":
    ...
    random_hiding = DegreeHiding(graph, edge_budget, node, community, detection_alg)
